Bitcoin Core version 0.11.0 is now available from:
  ...
  <https://icomex.org/bin/icomex-core-0.11.0/>
...
For example, add the following to `icomex.conf`:
...
related to the blockchain in the icomex system: the raw blocks as received over 
...
For an example script see [icomex-submittx](https://github.com/laanwj/icomex-submittx).
...
- #5334 `cf87536` libicomexconsensus: Add pkg-config support
...
- #6269 `95aca44` gitian: Use the new icomex-detached-sigs git repo for OSX signatures
...
- #5753 `0f44672` Add icomex logo to about screen
...
- #5809 `46bfbe7` Add icomex-cli man page
...
- #5849 `41259ca` contrib/init/icomexd.openrc: Compatibility with previous OpenRC init script variables
...
- #6098 `7708fcd` Update Windows resource files (and add one for icomex-tx)
