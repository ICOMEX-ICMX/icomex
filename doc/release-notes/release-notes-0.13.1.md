Bitcoin Core version 0.13.1 is now available from:
  ...
  <https://icomex.org/bin/icomex-core-0.13.1/>
...
- **Signature covers value:** A simple improvement in the way signatures are
  ...
  of icomexs they think they are spending, and by having full nodes refuse to
  accept those signatures unless the amount of icomexs being spent is exactly
...
- **Increased security for multisig:** Icomex addresses (both P2PKH addresses
...
[Segwit FAQ]: https://icomexcore.org/en/2016/01/26/segwit-benefits/
[segwit wallet Developers guide]: https://icomexcore.org/en/segwit_wallet_dev/
[BIP141]: https://github.com/icomex/bips/blob/master/bip-0141.mediawiki
[BIP143]: https://github.com/icomex/bips/blob/master/bip-0143.mediawiki
[BIP144]: https://github.com/icomex/bips/blob/master/bip-0144.mediawiki
[BIP145]: https://github.com/icomex/bips/blob/master/bip-0145.mediawiki
[versionbits FAQ]: https://icomexcore.org/en/2016/06/08/version-bits-miners-faq/
...
[BIP147]: https://github.com/icomex/bips/blob/master/bip-0147.mediawiki
...
- #8848 `7a34a46` Add NULLDUMMY verify flag in icomexconsensus.h (jl2012)
...
- #8940 `5b4192b` Add x9 service bit support to dnsseed.bluematt.me, seed.icomexstats.com (TheBlueMatt, cdecker)
- #8944 `685e4c7` Remove bogus assert on number of oubound connections. (TheBlueMatt)
- #8949 `0dbc48a` Be more agressive in getting connections to peers with relevant services (gmaxwell)

### Build system
- #8293 `fa5b249` Allow building libicomexconsensus without any univalue (luke-jr)
- #8492 `8b0bdd3` Allow building bench_icomex by itself (luke-jr)
...
- #8829 `2a8bca4` Add icomex-tx JSON tests (jnewbery)
- #8834 `1dd1783` blockstore: Switch to dumb dbm (MarcoFalke)
- #8835 `d87227d` nulldummy.py: Don't run unused code (MarcoFalke)
- #8836 `eb18cc1` icomex-util-test.py should fail if the output file is empty (jnewbery)
...
- #8860 `0bee740` util: Move wait_icomexds() into stop_nodes() (MarcoFalke)
...
- #8683 `8a7d7ff` Fix incorrect file name icomex.qrc  (icomexsSG)
...
- #8817 `bcf3806` update icomex-tx to output witness data (jnewbery)
