Bitcoin Core version 0.13.2 is now available from:
  ...
  <https://icomex.org/bin/icomex-core-0.13.2/>
...
- #8908 `4a974b2` Update icomex-qt.desktop (s-matthew-english)
...
- #8932 `106da69` Allow icomex-tx to create v2 transactions (BTCdrak)
