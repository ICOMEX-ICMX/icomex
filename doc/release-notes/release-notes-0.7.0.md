Bitcoin version 0.7.0 is now available for download at:
  http://sourceforge.net/projects/icomex/files/Bitcoin/icomex-0.7.0/

We recommend that everybody running prior versions of icomexd/Bitcoin-Qt
...
source-only tarballs/zipballs directly from there:
  https://github.com/icomex/icomex/tarball/v0.7.0  # .tar.gz
  https://github.com/icomex/icomex/zipball/v0.7.0  # .zip
...
in your terminal, then install the icomex-qt package:
  sudo apt-get install icomex-qt
...
Core icomex handling and blockchain database
...
* Ensure a changed icomex unit immediately updates all GUI elements that use units
...
* (Windows only): enable ASLR and DEP for icomex-qt.exe
* (Windows only): add meta-data to icomex-qt.exe (e.g. description)
...
* Bash programmable completion for icomexd(1)
