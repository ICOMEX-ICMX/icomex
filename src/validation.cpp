...
bool MemPoolAccept::PreChecks(ATMPArgs& args, Workspace& ws)
{
    ...
    if (!m_pool.CalculateMemPoolAncestors(*entry, setAncestors, m_limit_ancestors, m_limit_ancestor_size, m_limit_descendants, m_limit_descendant_size, errString)) {
        ...
        // this, see https://lists.linuxfoundation.org/pipermail/icomex-dev/2018-November/016518.html
...
CAmount GetBlockSubsidy(int nHeight, const Consensus::Params& consensusParams)
{
    ...
    {
       nSubsidy = 25000 * COIN; // 25,000,000 ICMX (Pre-mine/Insta-mine)
    }   
    else if(nHeight<=1577800) // next 2102400 Blocks
    {
        nSubsidy = 50 * COIN; // 4,204,800,000 ICMX
    }
    else if(nHeight<=3154600) // next 2102400 Blocks
    {
        nSubsidy = 25 * COIN; // 2,102,400,000 ICMX
    }
    else if(nHeight<=4731400) // next 2102400 Blocks
    {
        nSubsidy = 12.5 * COIN; // 1,051,200,000 ICMX
    } 
    else if(nHeight<=6308200) // next 2102400 Blocks
    {
        nSubsidy = 6.25 * COIN; // 525,600,000 ICMX
    } 
    else if(nHeight<=7885000) // next 2102400 Blocks
    {
        nSubsidy = 3.125 * COIN; // 262,800,000 ICMX
    } 
    else if(nHeight<=9461800) // next 2102400 Blocks
    {
        nSubsidy = 1.5625 * COIN; // 131,400,000 ICMX
    }
    else if(nHeight<=49029300) // next 2102400 Blocks
    {
        nSubsidy = 0.5 * COIN; // 131,400,000 ICMX
    } 
    else
    {
        nSubsidy = 0 * COIN;
