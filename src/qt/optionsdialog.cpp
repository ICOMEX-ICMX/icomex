    ...
    mapper(nullptr)
{
    ...
    ui->icomexAtStartup->setVisible(false);
    ui->verticalLayout_Main->removeWidget(ui->icomexAtStartup);
    ...
    ui->icomexAtStartup->setToolTip(ui->icomexAtStartup->toolTip().arg(PACKAGE_NAME));
    ui->icomexAtStartup->setText(ui->icomexAtStartup->text().arg(PACKAGE_NAME));
...
{
    /* Main */
    mapper->addMapping(ui->icomexAtStartup, OptionsModel::StartAtStartup);
