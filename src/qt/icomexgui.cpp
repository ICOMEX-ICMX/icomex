...
void BitcoinGUI::createActions()
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a Icomex address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and Icomex : URIs)"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your Icomex addresses to prove you own them"));
    verifyMessageAction = new QAction(tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified Icomex addresses"));
    ...
    openAction->setStatusTip(tr("Open a icomex: URI"));
...
void BitcoinGUI::updateNetworkState()
{
    ...
    if (m_node.getNetworkActive()) {
        tooltip = tr("%n active connection(s) to Icomex network", "", count) + QString(".<br>") + tr("Click to disable network activity.");
    } else {
