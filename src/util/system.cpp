...
const char * const BITCOIN_CONF_FILENAME = "icomex.conf";
 ...
 * https://github.com/icomex/icomex/pull/16097#issuecomment-514627823
 */
...
bool ArgsManager::ParseParameters(int argc, const char* const argv[], std::string& error)
{
    ...
    for (int i = 1; i < argc; i++) {
        ...
        if (key == "-") break; //icomex-tx using stdin
        std::string val;
...
{
    // Windows < Vista: C:\Documents and Settings\Username\Application Data\Icomex
    // Windows >= Vista: C:\Users\Username\AppData\Roaming\Icomex
    // Mac: ~/Library/Application Support/Icomex
    // Unix: ~/.icomex
#ifdef WIN32
    // Windows
    return GetSpecialFolderPath(CSIDL_APPDATA) / "Icomex";
#else
    fs::path pathRet;
...
#ifdef MAC_OSX
    // Mac
    return pathRet / "Library/Application Support/Icomex";
#else
    // Unix
    return pathRet / ".icomex";
#endif
#endif
}
