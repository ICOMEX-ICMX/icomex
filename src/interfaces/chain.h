...
//! internal workings of the icomex node, and not being very convenient to use.
...
//!   asynchronously
//!   (https://github.com/icomex/icomex/pull/10973#issuecomment-380101269).
//!
//! * The initMessage() and showProgress() methods which the wallet uses to send
//!   notifications to the GUI should go away when GUI and wallet can directly
//!   communicate with each other without going through the node
//!   (https://github.com/icomex/icomex/pull/15288#discussion_r253321096).
//!
