...
/* A AEAD class for ChaCha20-Poly1305@icomex.
 *
 ...
 *
 * The chacha20-poly1305@icomex combines these two primitives into an
 ...
 *
 * The chacha20-poly1305@icomex cipher requires two 256 bits of key material as
 ...
 * on the send channel.
 *
 * Optimized implementations of ChaCha20-Poly1305@icomex are relatively fast in
