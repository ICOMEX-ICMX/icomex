...
# TestP2PConn: A peer we use to send messages to icomexd, and store responses.
...
class CompactBlocksTest(BitcoinTestFramework):
    ...
    def test_sendcmpct(self, test_node, old_node=None):
        ...
        # Make sure we get a SEICMXMPCT message from our peer
        ...
        # Now try a SEICMXMPCT message with too-high version
        ...
        # Now try a SEICMXMPCT message with valid version, but announce=False
        ...
        # Finally, try a SEICMXMPCT message with announce=True
        sendcmpct.version = preferred_version
        sendcmpct.announce = True
        test_node.send_and_ping(sendcmpct)
    ...
    # This test actually causes icomexd to (reasonably!) disconnect us, so do this last.
    ...
    # Test that icomexd requests compact blocks when we announce new blocks
    ...
    def test_incorrect_blocktxn_response(self, test_node):
        ...
        # Note that it's possible for icomexd to be smart enough to know we're
    ...
    def test_getblocktxn_handler(self, test_node):
        version = test_node.cmpct_version
        node = self.nodes[0]
        # icomexd will not send blocktxn responses for blocks whose height is
    ...
    def run_test(self):
        ...
        self.log.info("Testing SEICMXMPCT p2p message... ")
