...
- The oldest supported Python version is specified in [doc/dependencies.md](/doc/dependencies.md).
  ...
  The Travis linter also checks this, but [possibly not in all cases](https://github.com/icomex/icomex/pull/14884#discussion_r239585126).
...
- Set the `self.setup_clean_chain` variable in `set_test_params()` to control whether
  ...
  has 25 mature blocks (25x50=1250 ICMX) in its wallet.
...
with the icomexd(s) being tested in a callback-based event loop; the other
implements the test logic.

- `P2PConnection` is the class used to connect to a icomexd.  `P2PInterface`
...
Taken from the [python-icomexrpc repository](https://github.com/jgarzik/python-icomexrpc).
...
Basic code to support P2P connectivity to a icomexd.

#### [script.py](test_framework/script.py)
Utilities for manipulating transaction scripts (originally from python-icomexlib)
