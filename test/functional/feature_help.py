...
"""Verify that starting icomex with -h works as expected."""
...
class HelpTest(BitcoinTestFramework):
    ...
    def run_test(self):
        self.log.info("Start icomex with -h for help text")
        ...
        self.log.info("Start icomex with -version for version information")
        ...
        self.log.info("Start icomexd with -fakearg to make sure it does not start")
