...
class BackwardsCompatibilityTest(BitcoinTestFramework):
    ...
    def setup_nodes(self):
        ...
        self.add_nodes(self.num_nodes, extra_args=self.extra_args, versions=[
            ...
            self.options.icomexd,
            self.options.icomexd,
            releases_path + "/v0.19.0.1/bin/icomexd",
            releases_path + "/v0.18.1/bin/icomexd",
            releases_path + "/v0.17.1/bin/icomexd"
        ], binary_cli=[
            self.options.icomexcli,
            self.options.icomexcli,
            releases_path + "/v0.19.0.1/bin/icomex-cli",
            releases_path + "/v0.18.1/bin/icomex-cli",
            releases_path + "/v0.17.1/bin/icomex-cli"
        ])
    ...
    def run_test(self):
        ...
        # RPC loadwallet failure causes icomexd to exit, in addition to the RPC
