...
class NotificationsTest(BitcoinTestFramework):
    ...
    def run_test(self):
        ...
        if self.is_wallet_compiled():
            ...
            # https://github.com/icomex/icomex/pull/9371, it might be better
            ...
            # https://github.com/icomex/icomex/pull/16624. The bug is reported
            # in issue https://github.com/icomex/icomex/issues/18325.
