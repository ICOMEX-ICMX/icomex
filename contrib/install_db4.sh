...
if [ -z "${1}" ]; then
  ...
  echo "This is probably \`pwd\` if you're at the root of the icomex repository."
  exit 1
fi
...
# See https://github.com/icomex/icomex/issues/16064
...
echo 'When compiling icomexd, run `./configure` in the following way:'
echo
