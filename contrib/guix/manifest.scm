...
(define* (make-icomex-cross-toolchain target
                                  #:key
...
(packages->manifest
 (list ;; The Basics
       ...
       (make-icomex-cross-toolchain "i686-linux-gnu")
       (make-icomex-cross-toolchain "x86_64-linux-gnu")
       (make-icomex-cross-toolchain "aarch64-linux-gnu")
       (make-icomex-cross-toolchain "arm-linux-gnueabihf")
       ...
       (make-icomex-cross-toolchain "riscv64-linux-gnu"
