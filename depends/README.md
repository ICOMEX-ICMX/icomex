...
RISC-V known issue: gcc-7.3.0 and gcc-7.3.1 result in a broken `test_icomex` executable (see https://github.com/icomex/icomex/pull/13543),
...
options will be passed to icomex's configure. In this case, `--disable-wallet`.
