...
[good first issue](https://github.com/icomex/icomex/issues?q=is%3Aopen+is%3Aissue+label%3A%22good+first+issue%22)
list or participate in a weekly [Bitcoin Core PR Review Club](https://icomexcore.reviews/) meeting.

Communication Channels
----------------------

Most communication about Bitcoin Core development happens on IRC, in the
#icomex-core-dev channel on Freenode. The easiest way to participate on IRC is
with the web client, [webchat.freenode.net](https://webchat.freenode.net/). Chat
history logs can be found
on [http://www.erisian.com.au/icomex-core-dev/](http://www.erisian.com.au/icomex-core-dev/)
and [http://gnusha.org/icomex-core-dev/](http://gnusha.org/icomex-core-dev/).

Discussion about code base improvements happens in GitHub issues and on pull
requests.

The developer
[mailing list](https://lists.linuxfoundation.org/mailman/listinfo/icomex-dev)
...
the pull request affects. Valid areas as:
  ...
  - `qt` or `gui` for changes to icomex-qt
...
[Translation Process](https://github.com/icomex/icomex/blob/master/doc/translation_process.md)
...
https://github.com/icomex/icomex/pull/16189).

Also see the [backport.py script](
https://github.com/icomex-core/icomex-maintainer-tools#backport).
